...
func Test_Loss(t *testing.T) {
	...
	tests := []struct {
		...
		{Hinge, args{xE, xA}, 2.4},
		{Hinge, args{yE, yA}, 2.4},
		{Hinge, args{zE, zA}, 2.7},
		...
		{Hinge, args{jE, jA}, 2.6500000000000004},
		{Hinge, args{kE, kA}, 2.65},
		{Hinge, args{lE, lA}, 2.7624999999999997},
