...
type TrainingData struct {
	Training []*Data `protobuf:"bytes,1,rep,name=training" json:"training,omitempty"`
	Test     []*Data `protobuf:"bytes,2,rep,name=test" json:"test,omitempty"`
}
...
func (m *TrainingData) GetTraining() []*Data {
	if m != nil {
		return m.Training
	}
	return nil
...
func (m *TrainingData) GetTest() []*Data {
	if m != nil {
		return m.Test
	}
	return nil
...
func (this *TrainingData) Equal(that interface{}) bool {
	...
	if len(this.Training) != len(that1.Training) {
		return false
	}
	for i := range this.Training {
		if !this.Training[i].Equal(that1.Training[i]) {
			return false
		}
	}
	if len(this.Test) != len(that1.Test) {
		return false
	}
	for i := range this.Test {
		if !this.Test[i].Equal(that1.Test[i]) {
			return false
		}
	}
	return true
...
func (this *TrainingData) GoString() string {
	...
	if this.Training != nil {
		s = append(s, "Training: "+fmt.Sprintf("%#v", this.Training)+",\n")
	}
	if this.Test != nil {
...
func (this *TrainingData) String() string {
	...
	s := strings.Join([]string{`&TrainingData{`,
		`Training:` + strings.Replace(fmt.Sprintf("%v", this.Training), "Data", "Data", 1) + `,`,
		`Test:` + strings.Replace(fmt.Sprintf("%v", this.Test), "Data", "Data", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *TrainingData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Training = append(m.Training, &Data{})
			if err := m.Training[len(m.Training)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
var fileDescriptorNn = []byte{
	...
	,
}
